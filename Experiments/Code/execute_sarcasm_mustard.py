...
""" File to store log"""
f = open('/home/development/apoorvan/AN_MTP/cikm/log/sarcasm_mutard/' +
         filename+'.txt', 'w')
        ...
        for batch_size in [128, 64]:
            for shared_embedding_size, projection_embedding_size in zip([2048, 1024], [1024, 512]):
                ...
                for fold in range(5):
                    ...
                    """
                    train = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/split_mustard/train_' + str(fold)+'.csv')
                    valid = pd.read_csv(
                        '/home/development/apoorvan/AN_MTP/cikm/data/split_mustard/test_' + str(fold)+'.csv')
                    seed()
                ...
                stats.to_csv('/home/development/apoorvan/AN_MTP/cikm/stats/sarcasm_mutard/' +
                ...
                results.to_csv('/home/development/apoorvan/AN_MTP/cikm/predictions/sarcasm_mutard/' + args.mode+'/' +
